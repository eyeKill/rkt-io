...
def benchmark_nginx_native(
	...
	benchmark_nginx(settings, "nginx-native", "native", nginx_server, remote_wrk, wrk_args, bench_result)
...
def benchmark_nginx_sgx_lkl(
	...
	benchmark_nginx(settings, "nginx-sgx-lkl", "sgx-lkl", nginx_server, remote_wrk, wrk_args, bench_result, extra_env=extra_env)
...
def benchmark_nginx_sgx_io(
	...
	benchmark_nginx(settings, "nginx-sgx-io", "sgx-io", nginx_server, remote_wrk, wrk_args, bench_result, extra_env=extra_env)
